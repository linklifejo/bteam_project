...
<div class='btnSet api'>
	<a hidden="hide">약국정보</a>
	<a hidden="hide">유기동물정보</a>
	<a>산 정보</a>
	<a href="#" onclick="window.open('https://map.forest.go.kr/forest/?systype=mapSearch&searchOption=trail#/','width=#,height=#')">산 등산코스 정보</a>
</div>
